defmodule Toia.VideosQuestionsStreamsTest do
  ...
  describe "videos_questions_streams" do
    ...
    test "get_video_question_stream!/1 returns the video_question_stream with given id" do
      video_question_stream = video_question_stream_fixture()
      assert VideosQuestionsStreams.get_video_question_stream!(video_question_stream.id) == video_question_stream
    end
    ...
    test "create_video_question_stream/1 with valid data creates a video_question_stream" do
      ...
      assert {:ok, %VideoQuestionStream{} = video_question_stream} = VideosQuestionsStreams.create_video_question_stream(valid_attrs)
    ...
    test "create_video_question_stream/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} = VideosQuestionsStreams.create_video_question_stream(@invalid_attrs)
    end
    ...
    test "update_video_question_stream/2 with valid data updates the video_question_stream" do
      ...
      assert {:ok, %VideoQuestionStream{} = video_question_stream} = VideosQuestionsStreams.update_video_question_stream(video_question_stream, update_attrs)
    ...
    test "update_video_question_stream/2 with invalid data returns error changeset" do
      video_question_stream = video_question_stream_fixture()
      assert {:error, %Ecto.Changeset{}} = VideosQuestionsStreams.update_video_question_stream(video_question_stream, @invalid_attrs)
      assert video_question_stream == VideosQuestionsStreams.get_video_question_stream!(video_question_stream.id)
    end

    test "delete_video_question_stream/1 deletes the video_question_stream" do
      video_question_stream = video_question_stream_fixture()
      assert {:ok, %VideoQuestionStream{}} = VideosQuestionsStreams.delete_video_question_stream(video_question_stream)
      assert_raise Ecto.NoResultsError, fn -> VideosQuestionsStreams.get_video_question_stream!(video_question_stream.id) end
    end

    test "change_video_question_stream/1 returns a video_question_stream changeset" do
      video_question_stream = video_question_stream_fixture()
      assert %Ecto.Changeset{} = VideosQuestionsStreams.change_video_question_stream(video_question_stream)
    end
  end
end
