defmodule Toia.Repo.Migrations.CreateVideosQuestionsStreams do
  ...
  def change do
    create table(:videos_questions_streams, primary_key: false) do
      ...
      add :id_question, references(:questions, on_delete: :delete_all, type: :serial), null: false, primary_key: true
      add :id_stream, references(:stream, on_delete: :delete_all, type: :serial, column: :id_stream), null: false, primary_key: true
