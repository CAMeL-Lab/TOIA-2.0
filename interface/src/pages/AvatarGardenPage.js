...
function AvatarGardenPage() {
	...
	function fetchSuggestedQuestions(
		...
		const options = {
			method: "GET",
			url: `/api/questions/suggestions/${toiaID}/pending`,
		};
	...
	function fetchRecordedQuestions(
		...
		const options = {
			method: "GET",
			url: `/api/questions/answered/${toiaID}/${streamID}`,
		};
	...
	const onEditSuggestion = () => {
		...
		const options = {
			...
			headers: { "Content-Type": "application/json" },
			data: {
				question_id: currentlyEditingSuggestion.id,
	...
	return (
		<div className="garden-page">
			...
			>
				...
				<div
					onClick={library}
					className="nav-talk_icon app-monsterrat-black nav-deselect"
				>
					Talk To TOIA
				</div>
				<div
					onClick={garden}
					className="nav-my_icon app-monsterrat-black nav-selected"
				>
					My TOIA
				</div>
				<div
					onClick={logout}
					className="nav-login_icon app-monsterrat-black nav-deselect"
				>
					Logout
				</div>
			</div>
			...
			<div className="section2">
				...
				>
					<div onClick={openModal}>
						<img
							className="garden-trash"
							src={trashIcon} // trash button
						/>
					</div>
					<div>
						...
						>
							<img
								className="garden-move_icon"
								src={moveIcon} //move button
							/>
						</IconButton>
						<Menu
							id="simple-menu"
