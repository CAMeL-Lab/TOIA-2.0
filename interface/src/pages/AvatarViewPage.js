	...
	return (
		<div className="view-page">
			...
			<div className="nav-heading-bar">
				...
				<div
					onClick={isLogin ? logout : openModal}
					className="nav-login_icon app-monsterrat-black"
				>
					{isLogin ? "Logout" : "Login"}
				</div>
			</div>
			<h1 className="view-title view-font-class-1 ">
				Here is infromation on the TOIA selected
			</h1>
			...
			<input
				...
				className="view-submit-button smart-layers-pointers "
				type="image"
				src={submitButton}
				alt="Submit"
			/>
