          ...
          <NavDropdown.Item href="#action/3.4">Separated link</NavDropdown.Item>
            ...
            <div>
                <div className="side-bar">
                    <h1 className="title font-class-3 ">Recorder</h1>
                    <div className="side-button b1 tooltip" style={{backgroundColor: bgColor1}}
                         onClick={changecolor}>Hello!
                        <span className="tooltiptext">
              Video type for initial greetings
              <br/>

              <i className="tooltipExample">Hi!, Hello!, Marhaba!, Nihao!</i>

            </span>
                    </div>
                    <div className="side-button b2 tooltip" style={{backgroundColor: bgColor2}}
                         onClick={changecolor}>Bye!
                        <span className="tooltiptext">
              Video type for farewell greetings
              <br/>
              <i className="tooltipExample"> Bye!, Goodbye!, Maa Salama!, Sayonara!</i>
          </span>
                    </div>
                    <div className="side-button b3 tooltip" style={{backgroundColor: bgColor3}}
                         onClick={changecolor}>Answer
                        <span className="tooltiptext">
              Video type for content answers to questions <br/>
              <i className="tooltipExample"> I love Pizza; My name is Mary.</i>
          </span>
                    </div>
                    <div className="side-button b4 tooltip" style={{backgroundColor: bgColor4}}
                         onClick={changecolor}>Yes/No
                        <span className="tooltiptext">
              Video type for positive/negative answers <br/>
              <i className="tooltipExample">Yes!, Right!, Yep!, No!, Never!</i>
          </span>
                    </div>
                    <div className="side-button b5 tooltip" style={{backgroundColor: bgColor5}}
                         onClick={changecolor}>Filler
                        <span className="tooltiptext">
              Video type for filler videos that will be used <br/>
              when waiting for the conversant to ask a question <br/>
              <i className="tooltipExample"> nodding head, smiling, brushing hair, sipping coffee, <br/>
                scratching nose, checking phone, ... </i>"
          </span>
                    </div>
                    <div className="side-button b6 tooltip" style={{backgroundColor: bgColor6}}
                         onClick={changecolor}>What?
                        <span className="tooltiptext">
                Video type for requests for more information<br/>
                <i className="tooltipExample"> I did not get that; sorry, can you repeat?; <br/>please elaborate?; huh?;<br/>
