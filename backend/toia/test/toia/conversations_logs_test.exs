defmodule Toia.ConversationsLogsTest do
  ...
  describe "conversations_log" do
    ...
    test "create_conversation_log/1 with valid data creates a conversation_log" do
      ...
      assert {:ok, %ConversationLog{} = conversation_log} =
               ConversationsLogs.create_conversation_log(valid_attrs)
    ...
    test "create_conversation_log/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} =
               ConversationsLogs.create_conversation_log(@invalid_attrs)
    end
    ...
    test "update_conversation_log/2 with valid data updates the conversation_log" do
      ...
      assert {:ok, %ConversationLog{} = conversation_log} =
               ConversationsLogs.update_conversation_log(conversation_log, update_attrs)
    ...
    test "update_conversation_log/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               ConversationsLogs.update_conversation_log(conversation_log, @invalid_attrs)
    ...
    test "delete_conversation_log/1 deletes the conversation_log" do
      ...
      assert {:ok, %ConversationLog{}} =
               ConversationsLogs.delete_conversation_log(conversation_log)

      assert_raise Ecto.NoResultsError, fn ->
        ConversationsLogs.get_conversation_log!(conversation_log.id)
      end
    end
